...
export default function TermsOfServicePage() {
  return (
    <LegalPageLayout title="Terms of Service" lastUpdated="June 26, 2026">
      ...
      <section>
        <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">3. User Accounts</h2>
      ...
      <section>
        <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">4. Medical Disclaimer</h2>
        <p>
      ...
      <section>
        <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">6. Appointments &amp; Payments</h2>
        <p>
      ...
      <section>
        <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">7. Intellectual Property</h2>
        <p>
      ...
      <section>
        <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">9. Termination</h2>
        <p>
      ...
      <section>
        <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">10. Changes to Terms</h2>
        <p>
      ...
      <section>
        <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">11. Governing Law</h2>
        <p>
      ...
      <section>
        ...
        <p>
          ...
          <a href="mailto:legal@medicareplus.com" className="text-blue-600 dark:text-blue-400 hover:underline">
