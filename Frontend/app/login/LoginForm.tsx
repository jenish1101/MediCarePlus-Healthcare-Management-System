        ...
        >
          ...
          <div className="mt-7 rounded-xl border border-blue-100 bg-blue-50/60 p-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-xs text-blue-500">Password: demo123</span>
            </div>
            <button
              type="button"
              onClick={() => setEmail(activeRole.demo)}
              className="w-full flex items-center justify-between gap-2 rounded-lg bg-white px-3 py-2.5 text-left border border-blue-100 hover:border-blue-300 transition-colors group"
            >
              <span className="flex items-center gap-2 text-sm text-gray-700">
                <activeRole.icon className="w-4 h-4 text-blue-600" />
                {activeRole.demo}
              </span>
              <span className="text-xs font-medium text-blue-600 group-hover:underline">Use</span>
            </button>
          </div>
