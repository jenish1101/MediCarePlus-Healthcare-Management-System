      ...
      <DashboardLayout role="admin">
        <div className="space-y-6 max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="text-gray-600 dark:text-gray-400">Configure hospital and platform settings</p>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-2 mb-5">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Hospital Information</h3>
            </div>
            <div className="grid sm:grid-cols-2 gap-5">
              <div className="sm:col-span-2">
                <label className="block text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Hospital Name</label>
                <input
                  value={hospital.name}
          ...
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-none dark:border dark:border-gray-700 p-6"
          >
            <h3 className="text-xl font-semibold mb-5 text-gray-900 dark:text-gray-100">Platform Configuration</h3>
          ...
          >
            <div className="flex items-center gap-2 mb-5">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Change Admin Password</h3>
            </div>
            <form className="grid sm:grid-cols-2 gap-6" onSubmit={(e) => e.preventDefault()}>
              <div className="sm:col-span-2">
                ...
                <input type="password" placeholder="••••••••" className="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-900 dark:text-gray-100 dark:placeholder-gray-500" />
              </div>
              <div>
          ...
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-none p-4 border border-red-100 dark:border-red-900/50"
          >
            <div className="flex items-center gap-2 mb-2">
              <Trash2 className="w-5 h-5 text-red-600 dark:text-red-400" />
              <h3 className="text-xl font-semibold text-red-700 dark:text-red-400">Danger Zone</h3>
            </div>
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
              Reset all system data to factory defaults. This action is irreversible.
            </p>
            <button className="px-5 py-2.5 border border-red-600 dark:border-red-700 text-red-600 dark:text-red-400 rounded-lg font-medium hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors">
              Reset System Data
            </button>
          </motion.div>
        </div>
